...
bool KeyValues::LoadFromFile(const DWORD filesystem, const char* resourceName, const char* pathID, const DWORD pfnEvaluateSymbolProc) 
{
	return reinterpret_cast<bool(__thiscall*)(void*, DWORD, const char*, const char*, DWORD)>(signatures_manager->signatures[SIGNATURE_LOAD_FROM_FILE_KEY_VALUE])(this, filesystem ? filesystem  : 0, resourceName, pathID, pfnEvaluateSymbolProc);
}
