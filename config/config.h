...
struct KeyBind
{
	...
	KeyBind(const string& name, int mode, Dependence dependence = DEPENDENCE_NONE, int key = KEY_NONE) //-V818
	{
		this->state = false;
		this->holding = false;
		this->key = key;
...
public:
	...
	virtual void save(std::string config);
	virtual void load(std::string config);
	virtual void config_files();
	virtual void remove(std::string config);
	...
	struct Legit
	{
		...
		{ //-V802
			...
			std::vector <int> hitboxes_priority;
	...
	struct AntiAim
	{
		...
		int roll_range = 50;
		std::vector <int> break_local_animation;
	...
	struct Visuals
	{
		struct player //-V730
		{
			...
			std::vector <int> chams_modifiers_arr_visible; // glow, wirefreame
			...
			std::vector <int> chams_modifiers_arr_invisible; // mettalic, glow, wirefreame
			...
			std::vector <int> chams_shot_modifiers_arr; // mettalic  glow, wirefreame
			...
			std::vector <int> chams_ghost_modifiers_arr; // mettalic  glow, wirefreame
			...
			std::vector <int> chams_fake_modifiers_arr; // mettalic  glow, wirefreame
			...
			std::vector <int> chams_hand_modifiers_arr; // mettalic  glow, wirefreame
			...
			std::vector <int> chams_weapon_modifiers_arr; // mettalic  glow, wirefreame
		...
		struct World //-V730
		{
			...
			{ //-V802
				...
				std::vector <int> chams_modifiers_arr; // 3
		...
		bool agent_changer;
		int player_model_t = 0;;
		int player_model_ct = 0;
	...
	struct Misc
	{
		...
		std::vector <int> logs_position;
		std::vector <int> bypasses;
